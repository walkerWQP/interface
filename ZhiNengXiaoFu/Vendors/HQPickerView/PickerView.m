...
//        for (int i = 0; i < self.array.count; i++) {
            ...
            NSString *arr = [self.array objectAtIndex:self.selectedRow];
...
//        }
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(pickerView:result:index:)]) {
        [_delegate pickerView:self result:resultStr index:self.selectedRow];
    }
