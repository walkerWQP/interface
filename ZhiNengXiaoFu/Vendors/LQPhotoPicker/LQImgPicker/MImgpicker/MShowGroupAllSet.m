...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"icon_normal_back_navbar_w100"] style:UIBarButtonItemStyleDone target:self action:@selector(back:)];
