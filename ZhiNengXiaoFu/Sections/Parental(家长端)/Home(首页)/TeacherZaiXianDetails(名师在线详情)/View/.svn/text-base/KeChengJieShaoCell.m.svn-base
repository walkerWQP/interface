...
- (void)creatUI
{
    ...
    self.jieShaoLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.userNName.frame.origin.x, self.userNName.frame.origin.y + self.userNName.frame.size.height + 5, 200, 20)];
    ...
    self.shanChangLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.shanChangImg.frame.origin.x + self.shanChangImg.frame.size.width + 5, self.shanChangImg.frame.origin.y, 100, 20)];
    ...
    self.shanChangConnectLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, self.shanChangImg.frame.origin.y + self.shanChangImg.frame.size.height + 15, kScreenWidth - 30, 200)];
