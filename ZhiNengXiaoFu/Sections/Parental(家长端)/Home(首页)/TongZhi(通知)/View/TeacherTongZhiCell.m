...
- (UILabel *)contentLabel {
    if (!_contentLabel) {
        self.contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.titleLabel.frame.origin.x, self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height + 10, kScreenWidth - self.titleLabel.frame.origin.x - 10, 15)];
...
- (UILabel *)timeLabel {
    if (!_timeLabel) {
        self.timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreenWidth - 70 - 20, self.contentLabel.frame.size.height + self.contentLabel.frame.origin.y + 5, 70, 20)];
